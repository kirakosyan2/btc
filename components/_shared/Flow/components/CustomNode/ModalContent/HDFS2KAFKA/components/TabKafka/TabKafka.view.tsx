        ...
        <UIFlex vertical>
                ...
                formProps={{
                    ...
                    label: (
                        <div className={cx('tooltipContainer')}>
                            ...
                            <UITooltip
                                title={`Топик, в который нужно записать данные (например, "PRF248LA.CONTRACTCREATEDUPDATEDEVENT.V1")`}>
                                <span>
                                    <Icon
                ...
                formProps={{
                    ...
                    label: (
                        <div className={cx('tooltipContainer')}>
                            ...
                            <UITooltip
                                title={`Верхняя граница на скорость отправки сообщений в Kafka (сообщений в секунду)`}>
                                <span>
                                    <Icon
                                        type="question-circle-outlined"
                                        size="xs"
            ...
            <UIFlex justify="center">
                <UIButton
                    ...
                    className={cx('btn')}
                    type="primary">
                    Сохранить настройки процесса записи данных в Kafka
                </UIButton>
            </UIFlex>
        </UIFlex>
    );
