...
import { TabRAView } from './TabRA.view';
import { MoveTable, UpdateStream, useUpdateStreamMutation } from '@src/redux/stream/stream';
...
export const TabRA: React.FC<Props> = ({ data, idDML, name, onClose }) => {
    ...
    const onSubmit = async (data: MoveTable) => {
